...
namespace Wasmtime.Tests
{
    ...
    public class MemoryImportBindingTests : IClassFixture<MemoryImportBindingFixture>, IDisposable
    {
        ...
        public void ItBindsTheGlobalsCorrectly()
        {
            ...
            var readByte = instance.GetFunction<int>("ReadByte");
            var readInt16 = instance.GetFunction<int>("ReadInt16");
            var readInt32 = instance.GetFunction<int>("ReadInt32");
            var readInt64 = instance.GetFunction<long>("ReadInt64");
            var readFloat32 = instance.GetFunction<float>("ReadFloat32");
            var readFloat64 = instance.GetFunction<double>("ReadFloat64");
            var readIntPtr = instance.GetFunction<long>("ReadIntPtr");
